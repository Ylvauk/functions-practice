...
//  Connection check: if you see this message in the browser console, you are all set!
...
function makeAnObject(par1="Hey",par2="You",par3="Guysssssss!!!") {
  const anything = {
    firstThing: par1,
    nextThing: par2,
    lastThing: par3
...
console.log(makeAnArray("a","b","c")); //should return an array
...
addToSum(5);
addToSum(-6);
console.log(sum); //should be 29 (returns as 29 but the npm test is not passing)
...
console.log(getArraySum()) //does return 0 in the console log though the test did not pick it up
